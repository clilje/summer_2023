...
def normalize_mag(i, age_gal_i,mstar_TNG):
    ...
    age_row = [0]
    #read in row 1
    ages = pd.read_csv('magnitude_figure/TNG50_out_17_gal_39361_no_dust.ised_ASCII',delimiter='/s', header=None, skiprows = lambda x: x not in age_row)
    ...
    specific_rows = [6]
    #read in row 7
    wavelength = pd.read_csv('magnitude_figure/TNG50_out_17_gal_39361_no_dust.ised_ASCII', header=None, skiprows = lambda x: x not in specific_rows)
    ...
    df = pd.read_csv('magnitude_figure/TNG50_out_17_gal_39361_no_dust.ised_ASCII',delimiter='/s', header=None, skiprows=7, skipfooter=12)
    ...
    """
    df_mass = pd.read_csv('TNG_50_library/TNG50_out_'+str(output_number)+'_gal_'+str(int(i))+'.mass',delimiter='/s', header=None, skiprows=30)
    ...
    #get first 7 lines
    front = pd.read_csv('magnitude_figure/TNG50_out_17_gal_39361_no_dust.ised_ASCII',delimiter='/s', header=None, skiprows = lambda x: x not in  [0,1,2,3,4,5,6])
    
    ###this section gets the "footer" section of the file in its undisturbed form, to join together
    back = pd.read_csv('magnitude_figure/TNG50_out_17_gal_39361_no_dust.ised_ASCII',delimiter='/s', header=None, skiprows = int(len(ages))+7)
    ...
    result.to_csv('magnitude_figure/TNG50_out_17_gal_39361_no_dust.ised_ASCII',header=None,index=None)
...
def make_ascii(output_number, galaxy_number):
    ...
    os.system('$bc03/ascii_ised magnitude_figure/TNG50_out_17_gal_39361_no_dust.ised')
...
def make_ised(output_number, galaxy_number):
    ...
    os.system('$bc03/bin_ised magnitude_figure/TNG50_out_17_gal_39361_no_dust.ised_ASCII')
    os.system('rm -f magnitude_figure/TNG50_out_17_gal_39361_no_dust.ised_ASCII')
    os.system('rm -f magnitude_figure/TNG50_out_17_gal_39361_no_dust.ised_ASCII')
...
if output_number == 17:
    ...
    df = pd.read_csv('TNG_50_library/library_galaxies'+str(output_number)+'.txt',header=None,
...
for x in [39361]:
    ...
    isedname = 'magnitude_figure/TNG50_out_17_gal_39361_no_dust.ised'
    outname = 'magnitude_figure/TNG50_out_17_gal_39361_no_dust'

...
df = pd.read_csv(work_dir+'library_galaxies'+str(output_number)+'.txt',header=None,
...
for tt in tau_V:
  for mm in mu:
        for x in [384]:
            ...
            cspname = 'TNG_50_library/TNG50_out_'+str(output_number)+'_gal_'+str(x)+'tau='+str(tt)+'mu='+str(mm)
            ...
            outname = 'TNG_50_library/TNG50_out_'+str(output_number)+'_gal_'+str(x)+'tau='+str(tt)+'mu='+str(mm)

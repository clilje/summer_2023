...
for x in df['galaxy number'].to_numpy():
    ...
    cspname = 'TNG50_out_'+str(output_number)+'_gal_'+str(x)+'_slopes'
    oname = work_dir+'/TNG50_out_'+str(output_number)+'_gal_'+str(x)+'_slopes.sed'
    #Calls the pygalaxev function to create a file with all the input for galaxevpl
    pygalaxev.create_galaxevpl_config(tmpname, work_dir+'/'+cspname+'.ised', oname, age)
    os.system('$bc03/galaxevpl < %s'%tmpname)
    ...
    cspname = 'TNG50_out_'+str(output_number)+'_gal_'+str(x)+'_slopes_moredust'
    oname = work_dir+'/TNG50_out_'+str(output_number)+'_gal_'+str(x)+'_slopes_moredust.sed'
    #Calls the pygalaxev function to create a file with all the input for galaxevpl
    pygalaxev.create_galaxevpl_config(tmpname, work_dir+'/'+cspname+'.ised', oname, age)
    os.system('$bc03/galaxevpl < %s'%tmpname)
    ...
    cspname = 'TNG50_out_'+str(output_number)+'_gal_'+str(x)+'_slopes_moredust_case2'
    oname = work_dir+'/TNG50_out_'+str(output_number)+'_gal_'+str(x)+'_slopes_moredust_case2.sed'
    #Calls the pygalaxev function to create a file with all the input for galaxevpl
    pygalaxev.create_galaxevpl_config(tmpname, work_dir+'/'+cspname+'.ised', oname, age)
    os.system('$bc03/galaxevpl < %s'%tmpname)
    ...
    cspname = 'TNG50_out_'+str(output_number)+'_gal_'+str(x)+'_slopes_nodust'
    oname = work_dir+'/TNG50_out_'+str(output_number)+'_gal_'+str(x)+'_slopes_nodust.sed'
    #Calls the pygalaxev function to create a file with all the input for galaxevpl
    pygalaxev.create_galaxevpl_config(tmpname, work_dir+'/'+cspname+'.ised', oname, age)
    os.system('$bc03/galaxevpl < %s'%tmpname)